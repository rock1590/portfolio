...
// Project Modal - Removed event listener for project cards
// The modal HTML and projectData are kept in case you want to re-introduce a "details" button later.
// const modal = document.getElementById("projectModal")
// const projectCards = document.querySelectorAll(".project-card")
// const closeModal = document.querySelector(".close-modal")

// const projectData = { ... } // This data is still available if needed
...
// Contact Form - Now sends data to API route
...
document.querySelectorAll(".nav-link, .footer-nav-link").forEach((link) => {
  ...
  link.addEventListener("click", (e) => {
    ...
    if (targetSection) {
      ...
      // Only add active class to navbar links, not footer links
  ...
  (entries) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        ...
        const navLink = document.querySelector(`a[href="#${sectionId}"].nav-link`) // Target only navbar links
